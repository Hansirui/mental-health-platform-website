...
export default function HistoryPage() {
  ...
  return (
    <div style={pageStyle}>
      ...
      <h2 style={{ fontSize: 36, fontWeight: 800, marginBottom: 20 }}>历史记录（闭环证明）</h2>
      ...
      <div style={cardStyle}>
        ...
        {history.length === 0 && <p style={{ color: "#cbd5e1" }}>暂无记录。</p>}
        {history.map((h) => (
          <div
            key={h.id}
            style={{
      ...
      <div style={{ ...cardStyle, marginTop: 18 }}>
        ...
        {logs.length === 0 && <p style={{ color: "#cbd5e1" }}>暂无操作记录。</p>}
